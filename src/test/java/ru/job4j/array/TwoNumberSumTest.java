...
class TwoNumberSumTest {
    ...
    @Test
    void whenWithNegativeNumbersYesTargetGetIndexV2() {
        int[] array = {-7, -5, 0, 5, 8, 12};
        int target = 3;
        int[] result = TwoNumberSum.getIndexV2(array, target);
        int[] expected = {1, 4};
        assertThat(result).isEqualTo(expected);
    }

    @Test
    void whenWithoutNegativeNumbersYesTargetGetIndexV2() {
    ...
    @Test
    void whenTwoEqualsNumbersYesTargetGetIndexV2() {
        int[] array = {5, 5};
        int target = 10;
        int[] result = TwoNumberSum.getIndexV2(array, target);
        int[] expected = {0, 1};
    ...
    @Test
    void whenTwoEqualsNumbersNoTargetGetIndexV2() {
        int[] array = {5, 5};
        int target = 12;
        int[] result = TwoNumberSum.getIndexV2(array, target);
        int[] expected = {};
